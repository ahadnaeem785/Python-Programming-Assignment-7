...
if __name__ == "__main__":
    ...
    librarian.add_book(library_manager, 101, "To Kill a Mockingbird", "Harper Lee")
    librarian.add_book(library_manager, 102, "Moby Dick", "Herman Melville") 
    ...
    # Create a member
    member = Member(2, "Ahad Naeem", "ahad@example.com")
